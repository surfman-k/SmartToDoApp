  ...
  return knex('todolist')
    .then(function () {
      return Promise.all([
        ...
        knex('todolist').insert({name: 'Mom and Pop sandwich shop', user: 3, category: 3, createdOn: '09-12-2017', completeBy: '11-12-2017', comment: 'Recommend by Jawsh!' }),
        knex('todolist').insert({name: 'Dyson hairdryer', user: 4, category: 4, createdOn: '09-12-2017', completeBy: '11-12-2017', comment: 'It\'s coo '}),
